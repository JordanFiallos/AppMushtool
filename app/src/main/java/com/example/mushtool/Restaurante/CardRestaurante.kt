...
@Composable
fun CardCustum(_restauranteF: DataRestauranteF, navController: NavHostController) {
            ...
            Column(
                ...
                Box(
                    ...
                    Image(
                        ...
                        painter = rememberAsyncImagePainter(_restauranteF.imagen),
                        contentDescription = "Soy restaurante ",
                            ...
                            Text(
                                ...
                                buildAnnotatedString {
                                    ...
                                    withStyle(style = SpanStyle(color = Color.Black)) {
                                        append(_restauranteF.direccion)
                                    }
                                }
                            )
                            Text(
